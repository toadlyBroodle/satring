...
class Settings:
    ...
    AUTH_OWNER_AUDIENCE_PRICE_SATS: int = int(os.getenv("AUTH_OWNER_AUDIENCE_PRICE_SATS", "200"))
    AUTH_OWNER_AUDIENCE_PRICE_USD: str = os.getenv("AUTH_OWNER_AUDIENCE_PRICE_USD", "0.10")
